...
public class BloggerController {
	...
	public  static String  imgPath = "C:" + File.separator + "Final Project"  + File.separator + "Travel_log" + File.separator + "safar-ui" + File.separator + "safar" + File.separator + "public"  + File.separator + "Images";
